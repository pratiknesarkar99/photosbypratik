...
<html>
	...
	<body>
			...
			<div class="container">
				...
				<nav>
					<ul>
						...
						<li class="current"><a href="portraits.php">Portraits</a></li>
		...
		<div class="container">	
			...
			<h3 id="h" style="text-align: center; color: red;"> Insert images to Album Portraits</h2>
		...
		<div style="text-align:justify; margin:20px; border-top: red 3px solid;">
			<h2 id="h" style="text-align: center; color: red;"> Images in Album Portraits</h2>
				<?php
