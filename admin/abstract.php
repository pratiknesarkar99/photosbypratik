...
<html>
	...
	<body>
		...
		<div class="container">	
			...
			<h3 id="h" style="text-align: center; color: red;"> Insert images to Album Abstract</h2>
		...
		<div style="text-align:justify; margin:20px; border-top: red 3px solid;">
			<h2 id="h" style="text-align: center; color: red;"> Images in Album Abstract</h2>
				<?php
